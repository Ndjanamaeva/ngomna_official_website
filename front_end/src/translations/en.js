export const en = {
  ...
  'about.description': 'nGomna is a cutting-edge mobile application developed in partnership with Cameroon Government institutions to transform the interaction between citizens and Government services.',
