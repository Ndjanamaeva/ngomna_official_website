...
sequelize.sync({ force: true }) // This will recreate the tables
  .then(async () => {
    ...
    const texts = await Text.bulkCreate([
      ...
      { title: 'Messaging', content: 'Secure messaging for government services', pageId: pages[3].id, section: sections[1].id },
      { title: 'DGI', content: 'Tax information and services', pageId: pages[4].id, section: sections[1].id },
      { title: 'GOV-AI', content: 'AI-powered government assistance', pageId: pages[5].id, section: sections[1].id },
      { title: 'Mission', content: 'Our commitment to serving you', pageId: pages[6].id, section: sections[1].id },
      { title: 'Vision', content: 'Building the future of digital governance', pageId: pages[7].id, section: sections[1].id },
      { title: 'Perspectives', content: 'Insights and future outlook', pageId: pages[8].id, section: sections[1].id },
      { title: 'WhatsApp', content: 'Connect with us on WhatsApp', pageId: pages[9].id, section: sections[1].id },
      { title: 'Email', content: 'Reach us via email', pageId: pages[10].id, section: sections[1].id },
      { title: 'Facebook', content: 'Follow us on Facebook', pageId: pages[11].id, section: sections[1].id },
      ...
      { title: 'DGI', content: 'Access DGI-related information and resources here.', pageId: pages[4].id },
      { title: 'GOV-AI', content: 'Experience the power of AI-driven government services with our GOV-AI assistant.', pageId: pages[5].id },
      { title: 'Mission', content: 'Learn about our mission and goals on this page.', pageId: pages[6].id },
      { title: 'Vision', content: 'Discover our vision for the future on this page.', pageId: pages[7].id },
      { title: 'Perspectives', content: 'Explore different perspectives and insights here.', pageId: pages[8].id },
      { title: 'WhatsApp', content: 'Connect with us on WhatsApp through this page.', pageId: pages[9].id },
      { title: 'Email', content: 'Reach out to us via email using the information on this page.', pageId: pages[10].id },
  ...
  { title: 'about.future.service3.description', content: 'State control over citizen data with advanced security measures', section: sections[2].id }
    ...
    const links = await Link.bulkCreate([
      ...
      { label: 'DGI', menuId: featuresMenu.id, url: '/dgi', pageId: pages[4].id },
      { label: 'GOV-AI', menuId: featuresMenu.id, url: '/gov-ai', pageId: pages[5].id }
    ]);
